// // DONE     create 3 variable  button, input1 , input2
// // DONE     use getElementById method to store the "btn", "number1", "number2"
// // DONE     Add eventlistner to button that will just do call a function handleClick.
